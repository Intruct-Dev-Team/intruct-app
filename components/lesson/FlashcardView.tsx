...
import { Button, H3, Text, XStack, YStack, getTokenValue } from "tamagui";
...
export default function FlashcardView({
    ...
    return (
        <YStack flex={1} padding="$4">
            ...
            {/* Card Area */}
            <YStack flex={1} justifyContent="center" alignItems="center" marginVertical="$4">
                <TouchableOpacity
                    activeOpacity={1}
                    onPress={handleFlip}
                ...
                >
                    ...
                    <Animated.View
                        style={[
                            styles.card,
                            { backgroundColor: resolveThemeColor(colors.cardBackground) },
                            frontAnimatedStyle,
                        ]}
                    >
                        <Text
            ...
            <YStack marginTop="auto">
                ...
                <XStack gap="$3">
                    <Button
                        flex={1}
                        bordered
                        borderColor="$gray5" // Or use colors.textTertiary?
                        icon={null}
